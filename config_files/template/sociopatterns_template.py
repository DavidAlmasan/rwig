...
N, M = 50, 3 # Number of underlying states, Number of walkers IN THE SUBSET OF NODES

loss = 'mse'  # or 'KL_divergence_forward', 'mse', 'KL_divergence_backward
...
CFG.SOLVER.LR = 0.5
CFG.SOLVER.EPOCHS = 1000
CFG.SOLVER.LOSS_TYPE = loss
CFG.SOLVER.TOLERANCE = 1e-10
CFG.SOLVER.CHECKPOINT_EVERY_EPOCH = 10
